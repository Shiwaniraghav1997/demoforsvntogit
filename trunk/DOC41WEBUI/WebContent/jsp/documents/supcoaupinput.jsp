				...
				<table cellpadding="4" cellspacing="0" class="nohover">
					...
					<tbody class="portlet-table-body">
						...
						<tr>
							...
							<td><form:select path="partnerNumber" items="${vendorBatchForm.partners}" cssClass="portlet-form-input-field-mandatory" cssStyle="width:240px;" itemLabel="partnerLabel" itemValue="partnerNumber"/>*<doc41:error path="partnerNumber" /></td>
						</tr>
						<tr class="portlet-table-alternate">
							<th><doc41:translate label="VendorBatch" /></th>
							<td><form:input path="vendorBatch" cssClass="portlet-form-input-field-mandatory"  maxlength="70"/><doc41:error path="vendorBatch" />*</td>
						</tr>
						<tr>
