...
select object_id from DOC41WEB_FDT.UM_PERMISSIONS where code in ('DOC_BOL_DOWN','NAV_BOL_DOWN','DOC_AWB_DOWN','NAV_AWB_DOWN','DOC_FDACERT_DOWN','NAV_FDACERT_DOWN','DOC_BOL_UP','NAV_BOL_UP','DOC_AWB_UP','NAV_AWB_UP','DOC_CMR_UP','NAV_CMR_UP')
)
*/
