...
public class   SapVendorDC
	...
	public static final Class<DataCarrier> _DBX_DC_CLASS_SAPVENDORDC = DataCarrier.class;

	/** The master Class of this class. */
	public static final Class<BasicDataCarrier> MASTER_CLASS_SAPVENDORDC = BasicDataCarrier.class;
	...
	private static final long serialVersionUID = 20180319062713999L;
	...
	static {
		try {
			...
			throw new InitException( "Failed to detect return types of the getter methods of SapVendorDC!", e );
		}
	}

	/**
	 * The standard Constructor (Framework internal: do not use in applications!).
	 * @deprecated Use: static SapVendorDC newInstanceOfSapVendorDC()  instead, supports replacement by subclass!!! Constructor will once change from public to protected!!!
	 */
	@Deprecated
	public SapVendorDC() {
		super( (Boolean)null );
	 ...
	 */
	public static SapVendorDC newInstanceOfSapVendorDC() {
		return newInstanceOf( SapVendorDC.class );
	}
	 ...
	 */
	public static SapVendorDC newInstanceOfSapVendorDC( Locale pLoc ) {
		return localizeDC( newInstanceOfSapVendorDC(), pLoc );
	}
	 ...
	 */
	public static SapVendorDC newInstanceOfSapVendorDC( BasicDataCarrier pDC ) {
